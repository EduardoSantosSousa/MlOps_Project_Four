...
from src.data_processing import Gun_Dataset
...
class ModelTraining:
    ...
    def split_dataset(self):
        try:
            dataset = Gun_Dataset(self.dataset_path, self.device)
            ...
            logger.info("Data splitted sucessfuly.....")
    ...
    def train(self):
        try:
            ...
            for epoch in range(self.epochs):
                ...
                for i, (images, targets) in enumerate(train_loader):
                    ...
                    if isinstance(losses, dict):
                        ...
                        if total_loss==0:
                            logger.erro("There was error in losses capturing")
            ...
            raise CustomException("Failed to do train model ", e)
