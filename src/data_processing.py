...
class Gun_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            ...
            img_res = img_rgb/255
            img_res = torch.as_tensor(img_res).permute(2,0,1).to(self.device)
            ...
            raise CustomException("Faile to load data", e)
...
if __name__ =="__main__":
    ...
    dataset = Gun_Dataset(root=root_path, device=device)
